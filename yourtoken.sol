...
pragma solidity ^0.6.0;
library SafeMath { //safe maths; cant overflow ;)
...
contract ERC20 is Context, IERC20 {
    ...
    string private _symbol = "YOURTOKENTICKER"; //5 char max
...
abstract contract ERC20Capped is ERC20 {
    ...
    constructor () public {
        uint256 cap = 1200000000000000000000000000; // 1.2 billion token cap with 18 decimal places
        _cap = cap;
    }
...
pragma solidity ^0.6.0;
contract YOURTOKENNAME is ERC20Capped, ERC20Burnable, Roles, TokenRecover {
